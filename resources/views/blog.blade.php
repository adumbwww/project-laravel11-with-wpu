  ...
  <div class="min-h-full">
    ...
    <main>
      <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
        <!-- Your content -->
        <article>
          <h3>Zenless Zone Zero: Perilisan Resmi Dijadwalkan Juli 2024</h3>
          ...
          <figure>
            ...
            <figcaption>Zenless Zone Zero banner</figcaption>
          </figure>
          <p>
        ...
        <article>
          <h3>Wuthering Waves: Siap Berpetualang di Dunia Terbuka yang Menakjubkan!</h3>
