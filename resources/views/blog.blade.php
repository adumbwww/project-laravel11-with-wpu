<x-layout>
  ...
  <article class="py-5 max-w-screen-md border-b border-gray-300">
    <h3 class="mb-2 text-2xl tracking-tight font-bold text-gray-800">Zenless Zone Zero: Perilisan Resmi Dijadwalkan Juli 2024</h3>
    <div class="text-base text-gray-500">
      <a href="#">Adam Widianto</a> | 1 January 2024
    </div>
    <img src="img/zzz-banner.jpeg" alt="zzz-banner">
    <p class="my-4 font-light">
      Para penggemar action RPG dengan elemen roguelike, bersiaplah! Zenless Zone Zero, game terbaru dari HoYoverse, 
    ...
    <figure>
      <img src="/img/zzz-gameplay.jpg" alt="zzz-gameplay">
      <figcaption>Zenless Zone Zero Gameplay</figcaption>
    </figure>
    <p class="my-4 font-light">
    ...
    <figure>
      <img src="/img/zzz-mc.jpg" alt="main character">
      <figcaption>Main Character</figcaption>
    </figure>
    <p class="my-4 font-light">
  ...
  <article class="py-5 max-w-screen-md border-b border-gray-300">
    ...
    <div class="text-base text-gray-500">
      <a href="#">Adam Widianto</a> | 2 February 2024
    </div>
    <img src="img/ww-banner.jpg" alt="banner">
    <p class="my-4 font-light">
      Para penjelajah dunia fantasi, bersiaplah untuk petualangan baru yang luar biasa! Wuthering Waves, game open-world action RPG 
    ...
    <a href="" class="font-medium text-gray-500 hover:underline">Read more &raquo;</a>
    <figure>
      <img src="img/ww-gameplay.jpg" alt="gamplay-trailer">
      <figcaption>Wuthering Waves Trailer</figcaption>
    </figure>
    <p class="my-4 font-light">
